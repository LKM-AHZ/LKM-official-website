...
export const zh_CN: DeepStringRecord<typeof en> = {
  ...
  blog: {
    tags: "标签",
    categories: "分类",
    categoryLabel: "查看「{name}」分类下的全部文章",
    tagLabel: "查看「{name}」标签下的全部文章",
    bannerAlt: "博客横幅图片",
    imageSourceLabel: "访问图片来源",
    recentPosts: "最新文章",
    rssSubscribe: "RSS",
    collapse: "收起",
    prev: "上一个",
  ...
  team: {
    ...
    communities: {
      ...
      hobby: {
        ...
        rhythm: {
          name: "二次元的音游社",
          // 原为料理学社文案（误抄，与 en 侧同源）；沿用 forumData.categories.hobbyMusicGame.description 的表述
          desc: "讨论音游相关内容，分享谱面与技巧。",
        },
        cooking: {
          name: "料理学社",
  ...
  page: {
    ...
    admin: {
      ...
      bot: {
        overview: { title: "机器人概览" },
        platforms: { title: "机器人平台" },
        providers: { title: "模型提供商" },
        config: { title: "机器人配置" },
        extensions: { title: "机器人插件" },
        knowledge: { title: "机器人知识库" },
        logs: { title: "机器人日志" },
    ...
    home: {
      ...
      hero: {
        ...
        long: '在这里，科学与技术都脱离了学术象牙塔的刻板与遥远，变成每一位都能够去迸发、对于世界发问的好奇心。触手可及，摆脱功利视角，让更多人迸发对于知识的渴望，感受到理工科的美。我们打破专业门槛，让每一位热爱理性，崇尚科技的"爱好者"，也都能在这里找到同频的伙伴，共探万物运转的奥秘。',
        communityIntro: "社区简介",
        seekHelp: "寻求帮助",
      },
      resources: {
