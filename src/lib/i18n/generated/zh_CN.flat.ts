...
export const zhFlat = {
  ...
  "admin.delete": "删除",
  "admin.deleted": "已删除",
  "admin.dlq.attempts": "重投次数",
  "admin.dlq.confirmDiscard": "确定丢弃这条死信？此操作不可撤销。",
  "admin.dlq.createdAt": "落库时间",
  "admin.dlq.discard": "丢弃",
  "admin.dlq.discarded": "已丢弃",
  "admin.dlq.empty": "暂无死信",
  "admin.dlq.payload": "消息体",
  "admin.dlq.reason": "原因",
  "admin.dlq.requeue": "重投",
  "admin.dlq.requeued": "已重投",
  "admin.dlq.routingKey": "路由键",
  "admin.dlq.statusDiscarded": "已丢弃",
  "admin.dlq.statusPending": "待处理",
  "admin.dlq.statusRequeued": "已重投",
  "admin.dlq.title": "死信队列",
  "admin.edit": "编辑",
  ...
  "admin.sidebar.bot.config": "配置",
  "admin.sidebar.bot.extensions": "插件",
  "admin.sidebar.bot.knowledge": "知识库",
  "admin.sidebar.bot.logs": "运行日志",
  "admin.sidebar.bot.overview": "概览",
  "admin.sidebar.bot.platforms": "消息平台",
  "admin.sidebar.bot.providers": "模型提供商",
  "admin.sidebar.bot.settings": "设置",
  "admin.sidebar.botGroup": "机器人",
  "admin.sidebar.categories": "板块管理",
  "admin.sidebar.dashboard": "仪表盘",
  "admin.sidebar.dlq": "死信队列",
  ...
  "auth.login.passkeyComingSoon": "即将推出",
  ...
  "blog.tagLabel": "查看「{name}」标签下的全部文章",
  "blog.tags": "标签",
  "blog.tagsTitle": "文章标签",
  "blog.title": "博客",
  ...
  "community.competition.noCompetitions": "暂无竞赛",
  "community.competition.noQuestions": "没有符合筛选条件的题目",
  ...
  "community.fileLibrary.download": "下载",
  ...
  "community.fileLibrary.preview": "预览",
  ...
  "community.fileLibrary.selectedFile": "已选择：{name}（{size}）",
  ...
  "community.forum.subBoards": "个子板块",
  ...
  "page.admin.bot.config.title": "机器人配置",
  "page.admin.bot.extensions.title": "机器人插件",
  "page.admin.bot.knowledge.title": "机器人知识库",
  "page.admin.bot.logs.title": "机器人日志",
  "page.admin.bot.overview.title": "机器人概览",
  "page.admin.bot.platforms.title": "机器人平台",
  "page.admin.bot.providers.title": "模型提供商",
  "page.admin.bot.settings.title": "机器人设置",
  ...
  "page.admin.documents.statusFilter": "按状态筛选",
  ...
  "page.serverError.backHome": "返回首页",
  "page.serverError.error": "错误",
  "page.serverError.hint": "请稍后重试，或返回首页。",
  "page.serverError.message": "抱歉，服务器出现了一点问题。",
  "page.serverError.title": "服务器错误",
  ...
  "register.normal.resend": "重新发送验证码",
  "register.normal.resendCountdown": "重新发送（{seconds}s）",
  ...
  "team.communities.applied.geoscience.desc":
    "这里是理科迷·学术专业·应用科学·地学总群内容讨论交流群，是【腾讯物理部落】官方群之一，欢迎各对测绘、地质、矿业、安全，科学与工程等等，感兴趣和研究的本专业学生、地学老师、地学相关从业者、科研工作者、科普工作者、科技爱好者等人员。",
  ...
  "team.communities.hobby.rhythm.desc": "讨论音游相关内容，分享谱面与技巧。",
