...
const BinaryMatrixBackground = ({ fontSize = 18, fontFamily = 'Space Grotesk', color: propColor, rippleColor: propRippleColor, density = 0.05, className = '', flickerSpeed = 0.05, trailLength = 15, charSet = ['0', '1'], charChangeRate = 0.1, rippleGrowthRate = 3, rippleFadeRate = 0.015, rippleLineWidth = 2, mouseAffectRadius = 200 }) => {
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            columnsRef.current.forEach(column => {
                ...
                const distToMouse = Math.sqrt(Math.pow(x - mouseRef.current.x, 2) +
