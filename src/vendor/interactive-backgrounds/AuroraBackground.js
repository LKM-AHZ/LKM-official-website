...
const AuroraBackground = ({ mouseRadius = 150, rippleColor: propRippleColor, className = '', layers = 5, baseWaveHeight = 30, waveSpacing = 10, waveSpeed = 0.5, lineWidthBase = 2, rippleMaxRadius = 120, rippleGrowthRate = 3, rippleLineWidth = 2 }) => {
